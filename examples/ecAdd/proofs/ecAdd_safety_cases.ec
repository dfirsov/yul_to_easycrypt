...
have ->: (x2{hr} * x2{hr} * x2{hr} * R + 3 * R)
  = (x2{hr} * x2{hr} * x2{hr} + 3) * R. smt().
have ok : ! pointIsInCurve x2{hr} y1{hr} \/ ! pointIsInCurve x2{hr} y2{hr} . smt.
...
rcondt 3. inline 2. wp.  
ecall (pointIsInCurve_m_h x1 y1). skip. progress.
have ->: (x2{hr} * x2{hr} * x2{hr} * R + 3 * R) = (x2{hr} * x2{hr} * x2{hr}+ 3) * R. smt().
apply mul_inj_contra_pos. smt. smt. smt.
inline 3. while (true). auto. auto. exfalso.
...
seq 4 : ((((((((((
  ...
  ! func325 /\ x1 = x1_in * R %% P /\ y1 = y1_in * R %% P /\ x2 = x2_in * R %% P /\ y2 = y2_in * R %% P).  
ecall (into_m_h y2_in).
ecall (into_m_h x2_in).
ecall (into_m_h y1_in).
